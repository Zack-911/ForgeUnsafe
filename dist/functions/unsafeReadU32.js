...
exports.default = new forgescript_1.NativeFunction({
    name: '$unsafeReadU32',
    description: 'Read an unsigned 32-bit integer (little-endian) from a pointer.',
    version: '1.0.0',
    brackets: true,
    unwrap: true,
    ...
    execute(_ctx, [pointer]) {
        try {
            return this.success(String(native_1.native.unsafeReadU32(pointer)));
        }
        catch (e) {
...
//# sourceMappingURL=unsafeReadU32.js.map