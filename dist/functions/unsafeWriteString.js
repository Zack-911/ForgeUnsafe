...
exports.default = new forgescript_1.NativeFunction({
    ...
    args: [
        ...
        { name: 'value', description: 'String to write.', type: forgescript_1.ArgType.String, required: true, rest: false },
    ],
    execute(_ctx, [pointer, value]) {
        try {
            native_1.native.unsafeWriteString(pointer, value);
            return this.success();
        }
        catch (e) {
...
//# sourceMappingURL=unsafeWriteString.js.map