...
exports.default = new forgescript_1.NativeFunction({
    ...
    args: [
        ...
        { name: 'value', description: 'Unsigned 32-bit value.', type: forgescript_1.ArgType.Number, required: true, rest: false },
    ],
    execute(_ctx, [pointer, value]) {
        try {
            native_1.native.unsafeWriteU32(pointer, value);
            return this.success();
        }
        catch (e) {
...
//# sourceMappingURL=unsafeWriteU32.js.map